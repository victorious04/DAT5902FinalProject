...
class DataAnalysisTestFunctions(unittest.TestCase):
    ...
    def test_regressionAnalysis(self):
        ...
        with patch('builtins.print') as mock_print:
            ...
            mock_print.assert_any_call("Regression Coefficient (Slope): 2.0")
            mock_print.assert_any_call("R^2 Value: 1.0")
    ...
    def test_correlationTest(self):
        ...
        with patch('builtins.print') as mock_print:
            ...
            mock_print.assert_any_call("Pearson Correlation: 1.0")
    ...
    def test_createBarChart(self):
        ...
        try:
            ...
            self.fail(f"createBarChart rasied an exception: {e}")
